        ...
        .on('error.dt', function (e, settings, techNote, message) {
            ...
            "columns": [
                ...
                {'data': null,  "orderable": false,
                    render: function (data, type, full) {
                        if(data.lading_bill != null){
                            return "<a title='查看提单' href='#' id='billing_"+ data.id + "' onclick=show_billing(this);><i class='mdi mdi-download text-success'></i>" + "</a>";
                        } else {
                            return "提单暂未上传";
                        }
                    }
                ...
                {'data': null,  "orderable": false,
                    render: function (data, type, full) {
                        if(data.pod != null){
                            return data.depot_status+"&nbsp;<a title='查看POD' href='#' id='pod_"+ data.id + "' onclick=show_pod(this);><i class='mdi mdi-download text-success'></i>POD" + "</a>";
                        } else {
                            return data.depot_status;
                        }
                    }
                },
